...
class FlightPlanner:
        ...
        for index, supervisor_step in enumerate(supervisor_plan.steps, start=1):
            step = FlightStep(
                ...
                parameters={
                    ...
                    "provider": supervisor_step.provider,
                    "model": supervisor_step.model,
                    "model_policy": supervisor_step.model_policy,
                    "voice": supervisor_step.voice,
                    "allowed_mcps": ",".join(supervisor_step.allowed_mcps),
                    "tools": ",".join(supervisor_step.tools),
                    "priority": supervisor_step.priority,
                    "risk_level": supervisor_step.risk_level,
                    "parallel_group": supervisor_step.parallel_group,
                },
    ...
    def _action_for(agent_key: str) -> str:
        actions = {
            ...
            "devops": "verify_build_pipeline_and_deploy",
            "analyst": "classify_and_summarize_operational_signals",
            "research": "research_sources_and_uncertainties",
    ...
    def _success_for(agent_key: str) -> str:
        criteria = {
            ...
            "devops": "deploy verificabile o failure mode documentato",
            "analyst": "sintesi chiara con priorita operative",
            "research": "fonti e incertezze esplicitate",
